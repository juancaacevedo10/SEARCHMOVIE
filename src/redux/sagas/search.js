...
export function* searchMovie({ payload }){
    try{
        const results = yield call(apiCall, `&s=${payload.movieName}`, null, null, 'GET') //yield para que espere y luego llamamos la funcion
...
export function* searchMovieById({ payload }){
    ...
    try{
        const movie = yield call(apiCall, `&i=${payload.movieId}`, null, null, 'GET') //yield para que espere y luego llamamos la funcion
